                    ...
                    Row(
                            modifier =
                                    Modifier.fillMaxWidth()
                                            .padding(
                                                    horizontal = 4.dp
                                            ), // Align with 332px width in 1.css
                            horizontalArrangement = Arrangement.SpaceBetween
                    ) {
                        Text(text = "Сумма", style = Title2Semibold, color = Color.Black)
                        Text(
    ...
    Card(
        ...
        Box(modifier = Modifier.fillMaxSize()) {
            ...
            Text(
                    ...
                    color = Color.Black,
                    modifier = Modifier.padding(start = 16.dp, top = 16.dp).width(250.dp)
            )
            ...
            Row(
                ...
                Text(text = item.quantity.toString(), style = TextRegular, color = Color.Black)
