    ...
    Box(
        ...
        if (cartItems.isNotEmpty()) {
            ...
            Box(
                ...
                Column {
                    Row(
                        modifier = Modifier.fillMaxWidth().padding(horizontal = 4.dp), // Align with 332px width in 1.css
                    ...
                    Button(
                        onClick = {
                            scope.launch {
                                isProcessing = true
                                Toast.makeText(context, "Обработка заказа...", Toast.LENGTH_SHORT).show()
                                delay(5000)
                                isProcessing = false
                                viewModel.clearCart()
                        ...
                        shape = RoundedCornerShape(10.dp), // Updated to 10dp per spec
                        enabled = !isProcessing
                    ) {
                         Text(
                            text = if (isProcessing) "Обработка..." else "Оплатить",
        ...
        Box(modifier = Modifier.fillMaxSize()) {
            ...
            Row(
                ...
                IconButton(onClick = onDecrease, modifier = Modifier.size(20.dp)) {
                     Icon(painterResource(id = R.drawable.icon_minus), contentDescription = "Decrease", modifier = Modifier.size(12.dp), tint = Color(0xFFB8C1CC))
                }
                ...
                IconButton(onClick = onIncrease, modifier = Modifier.size(20.dp)) {
                     Icon(painterResource(id = R.drawable.icon_plus), contentDescription = "Increase", modifier = Modifier.size(12.dp), tint = Color(0xFF939396))
                }
            }
        }
    }
